---
title: GitHub CTF: CodeQL and Chill
...
![]({{ '/static/assets/codeql/1.1.1.png' | prepend: site.baseurl | replace: '//', '/' }})
...
![]({{ '/static/assets/codeql/1.1.2.png' | prepend: site.baseurl | replace: '//', '/' }})

<br/>
<br/>

_NOTE_: I attempted the bonus part too, it's writeup is present in the file [bonus.md](https://github.com/kanav99/github-java-ctf/tree/master/bonus.md). Do check it out if the submissions are close enough!
...
![]({{ '/static/assets/codeql/1.2.1.png' | prepend: site.baseurl | replace: '//', '/' }})
...
![]({{ '/static/assets/codeql/1.6.1.png' | prepend: site.baseurl | replace: '//', '/' }})
...
![]({{ '/static/assets/codeql/1.6.2.png' | prepend: site.baseurl | replace: '//', '/' }})
...
![]({{ '/static/assets/codeql/2.1.png' | prepend: site.baseurl | replace: '//', '/' }})
...
![]({{ '/static/assets/codeql/3.1.png' | prepend: site.baseurl | replace: '//', '/' }})

Final query (without bonus part) is available in the file ![final.ql](https://github.com/kanav99/github-java-ctf/tree/master/queries/final.ql).
...
![]({{ '/static/assets/codeql/tada.png' | prepend: site.baseurl | replace: '//', '/' }})
...
A more refined version of this payload is present in this [file](https://github.com/kanav99/github-java-ctf/tree/master/payloads/refined.sh) (if you need to see only json, see this [file](https://github.com/kanav99/github-java-ctf/tree/master/payloads/refined.json)) but the caveat is still present there. I never experienced a problem, but as we still are using indexes, problem can occur. Best way to handle this is by making a loop of all indexes and fetch the  method's signature and see at which index you see the required method.

A python project where you can run a complete shell (like in SSH) is present [here](https://github.com/kanav99/github-java-ctf/tree/master/titus-shell/).
<p align="center">
...
If you don't wish to run a shell, just copy the contents of the [refined.sh](https://github.com/kanav99/github-java-ctf/tree/master/payloads/refined.sh) file and paste it to your shell. You will see that a file `/tmp/pwn` is made in the `gateway` container.
...
![]({{ '/static/assets/codeql/lgtm.png' | prepend: site.baseurl | replace: '//', '/' }})
